        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            @if($busqueda)
                <div class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400 border-b dark:border-gray-700">
                    {{ $usuarios->count() }} resultado(s) para
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">
                                    @if($usuario->correo_verificado_en)
                                        <span class="text-green-500 font-semibold text-xs">Verificado</span>
                                    @else
                                        <span class="text-red-400 text-xs">Sin verificar</span>
                                    @endif
                                </td>
                                ...
                                <td class="px-4 py-3 text-right relative">
                                    <button onclick="toggleMenu('menu-{{ $usuario->id }}')"
