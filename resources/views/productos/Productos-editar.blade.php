                    ...
                    <div class="sm:col-span-2 border border-solare-musgo rounded-lg p-4">
                        ...
                        <div id="dropzone"
                            ...
                            <div id="dropzone-placeholder" class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="mb-2 text-sm text-gray-500"><span class="font-semibold">Click para cambiar</span>
                                    o arrastra aquí</p>
                                <p class="text-xs text-gray-500">PNG, JPG (máx. 2MB) — dejar vacío para mantener la actual
                                </p>
                            </div>
