                ...
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div
                        ...
                        <a href="{{ route('productos.create') }}"
                            class="flex items-center justify-center text-white bg-amber-400 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">SKU Base</th>
                            ...
                            @foreach ($productos as $producto)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <th scope="row"
                                        ...
                                        {{ $producto['nombre'] }}</th>
                                    <td class="px-4 py-3">{{ $producto['categoria']['nombre'] ?? 'N/A' }}</td>
